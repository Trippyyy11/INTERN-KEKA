...
export default function Dashboard({ onLogout }) {
    ...
    const renderContent = () => {
            ...
            return (
                <div className="page-content">
                    ...
                    <div style={{ background: 'linear-gradient(90deg, #b45309, #d97706)', borderRadius: 'var(--radius-lg)', padding: '2rem', marginBottom: '2rem', color: 'white' }}>
                        <h1 style={{ fontSize: '1.5rem', fontWeight: '600' }}>Welcome Tuba Zainab!</h1>
                    </div>
                                    ...
                                    <div style={{ padding: '1.25rem' }}>
                                        {attendanceTab === 'Attendance Log' && (
                                            <table className="data-table">
                                                <thead>
                                                    <tr><th>DATE</th><th>ATTENDANCE VISUAL</th><th>EFFECTIVE HOURS</th><th>GROSS HOURS</th><th>ARRIVAL</th></tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td style={{ fontWeight: 'bold' }}>Fri, 06 Mar</td>
                                                        <td><div style={{ width: '80%', height: '8px', background: '#083344', borderRadius: '4px' }}><div style={{ width: isClockedIn ? '60%' : '100%', height: '100%', background: '#06b6d4', borderRadius: '4px' }}></div></div></td>
                                                        <td>{isClockedIn ? '4h 42m' : '8h 00m'}</td>
                                                        <td>{isClockedIn ? '4h 42m' : '8h 00m'}</td>
                                                        <td><span style={{ color: 'var(--success)' }}>✓</span> On Time</td>
                                                    </tr>
                                                    <tr style={{ background: 'rgba(255,255,255,0.02)' }}>
                                                        <td style={{ fontWeight: 'bold' }}>Thu, 05 Mar <span style={{ background: '#374151', padding: '0.1rem 0.3rem', borderRadius: '2px', fontSize: '0.6rem', marginLeft: '0.5rem' }}>W-OFF</span></td>
                                                        <td><div style={{ width: '80%', height: '8px', background: '#083344', borderRadius: '4px' }}><div style={{ width: '40%', height: '100%', background: '#06b6d4', borderRadius: '4px' }}></div></div></td>
                                                        <td>9h 4m</td>
                                                        <td>9h 4m</td>
                                                        <td><span style={{ color: 'var(--warning)' }}>☺</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        )}
                            ...
                            <div className="panel">
                                ...
                                <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem', paddingBottom: '2rem', borderBottom: '1px solid var(--border-dark)' }}>
                                    <div>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>Basic Salary</span><span>$4,500.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>House Rent Allowance</span><span>$1,200.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>Special Allowance</span><span>$800.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem', color: 'var(--primary)' }}><span>Performance Bonus</span><span>$500.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem', fontSize: '1rem', fontWeight: 'bold' }}><span>Total Earnings</span><span>$7,000.00</span></div>
                                    </div>
                                    <div>
                                        <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '1rem' }}>DEDUCTIONS</div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>Provident Fund</span><span>$540.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>Income Tax (TDS)</span><span>$1,100.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', fontSize: '0.9rem' }}><span>Professional Tax</span><span>$25.00</span></div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1.85rem', fontSize: '1rem', fontWeight: 'bold', color: 'var(--danger)' }}><span>Total Deductions</span><span>$1,665.00</span></div>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(16, 185, 129, 0.1)', padding: '1.5rem', borderRadius: 'var(--radius-md)' }}>
                                    ...
                                    <span style={{ fontSize: '1.75rem', fontWeight: 'bold', color: '#10b981' }}>$5,335.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        if (['Org', 'Inbox', 'Engage', 'Performance'].includes(activeSidebar)) {
            return (
            ...
            <main className="main-content">
                <header className="topbar">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        <div style={{ fontSize: '1rem', fontWeight: '500' }}>Teaching Pariksha</div>
                    </div>
                    <div className="topbar-actions">
                        <button className="btn btn-danger" onClick={onLogout} style={{ padding: '0.25rem 0.75rem' }}>Log Out</button>
                        <Bell size={20} style={{ cursor: 'pointer' }} />
                        <div className="avatar" style={{ cursor: 'pointer', background: '#10b981' }}>TZ</div>
                    </div>
                </header>

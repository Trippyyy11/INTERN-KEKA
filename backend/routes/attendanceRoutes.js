...
router.get('/all', protect, authorize(['Reporting Manager', 'Reporting Officer', 'Super Admin']), getAllLogs);
router.get('/logs/:userId', protect, authorize(['Reporting Manager', 'Reporting Officer', 'Super Admin']), getUserLogs);
router.put('/logs/:logId', protect, authorize(['Reporting Manager', 'Reporting Officer', 'Super Admin']), updateAttendance);
